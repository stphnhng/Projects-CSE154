	...
	<body>
		...
		<p>
			...
			<?php
				...
				print $var;
			?> total songs,
			which is over <?= $var / 10 ?> hours of music!
		</p>
		...
		<div class="section">
			...
			<ol>
				...
				?>
				<li>
					<a href="https://www.google.com/search?tbm=nws&amp;q=Music&amp;start=<?= $i*10?>">
						Page <?= $i+1 ?>
					</a>
				</li>
				<?php } ?>
		...
		<div class="section">
			...
			<ol>
				<?php
					$file_names = file("favorite.txt");
					foreach($file_names as $name){
						$split = explode(" ",$name);
						$split[0] = $split[0] . "-" . $split[1];
						?>
						<li>
							<a href="https://www.vevo.com/artist/<?=$split[0]?>">
								<?=$name?>
							</a>
						</li>
						<?php
